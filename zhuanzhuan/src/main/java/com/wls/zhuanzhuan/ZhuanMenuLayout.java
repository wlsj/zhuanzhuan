...
/**
 * 架构：WLS on 2016/11/15 10:35
 * 邮箱：vchess@126.com
 */

public class ZhuanMenuLayout extends ViewGroup implements Runnable, View.OnClickListener {
    ...
    private OnZhuanSelectedListener onZhuanSelectedListener;

    private OnMenuSelectedListener onMenuSelectedListener;

    public ZhuanMenuLayout(Context context) {
        this(context, null);
    }

    public ZhuanMenuLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ZhuanMenuLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void run() {
        if (scroller.isFinished()) {
            ...
            if (onZhuanSelectedListener != null) {
                onZhuanSelectedListener.onZhuanSelected(position);
            }
        }
    ...
    /**
     * 获取圆形转动菜单的真正半径<br/>
     * 半径是依据 child 的高度加上 ZhuanMenuLayout 的宽度的一半<br/>
    ...
    public void setOnZhuanSelectedListener(OnZhuanSelectedListener listener) {
        onZhuanSelectedListener = listener;
    }
